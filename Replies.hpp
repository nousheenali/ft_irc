...
/*   Updated: 2023/06/06 10:41:03 by nali             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define ERR_UNKNOWNMODE(mod)                       ("472 " + mod + " :is unknown mode char to me for <channel>\r\n")
#define ERR_INVALIDMODEPARAM(channel, mod, param, msg) ("696 " + channel + " " + mod + " " + param + " " + msg + " Syntax: <key>.\r\n")
...
#define RPL_CREATIONTIME(servername, nick, channel, modes) (":" + servername + " 329 " + nick + " " + channel + " :+" + modes + "\r\n")
